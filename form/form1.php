						...
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									<div class="user-pic">
										<img src="anip.jpg" alt="user-img" class="rounded-circle mCS_img_loaded">
									</div>
									<div class="user-info">
										<h6 class=" mb-0 text-dark">afni fitria</h6>
										<span class="text-muted app-sidebar__user-name text-sm">Software engineering</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body h-100">
								<div class="row row-sm ">
									<div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
										<h4 class="product-title">selamat datangg</h4>
										<div class="action">
										</div>
									</div>
								</div>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <br><br>
  Gender:
  <input type="radio" name="gender" value="female">laki-laki
  <input type="radio" name="gender" value="male">perempuan
